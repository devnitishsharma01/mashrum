...
const { connectWhatsAppSchema, simulateInboundSchema } = require("../shared");
const { requireAuth, requirePermission, tenantId } = require("../middleware/auth");
const { getWhatsAppStatus, connectWhatsApp, disconnectWhatsApp } =
  require("../services/whatsapp/account.service");
const { simulateInboundMessage } = require("../services/whatsapp/webhook.service");
